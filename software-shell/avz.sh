...
# Mata 2 procesos python (izquierdo y derecho), espera 1 seg y corre 2 adicionales de AVANZAR.
#
...
sleep 2
nohup  python /data/scripts/wall-e/manual02/stepper_der_avz.py 1 >> /dev/null &
nohup  python /data/scripts/wall-e/manual02/stepper_izq_avz.py 1 >> /dev/null &
